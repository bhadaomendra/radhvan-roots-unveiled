    ...
    scripts: [
      {
        children: `
          ...
          })(window,document,'script','dataLayer','GTM-KGKT3H4T');
        `,
      },
      {
        src: "https://www.googletagmanager.com/gtag/js?id=G-SL60MQZ825",
        async: true,
      },
      {
        children: `
  ...
  return (
    <html lang="en">
      ...
      <body>
        <noscript>
          <iframe
            src="https://www.googletagmanager.com/ns.html?id=GTM-KGKT3H4T"
            height="0"
            width="0"
        ...
        <noscript>
          <img
            ...
            width="1"
            style={{ display: "none" }}
            src="https://www.facebook.com/tr?id=2102948430304505&ev=PageView&noscript=1"
            alt=""
          />
        </noscript>
        {children}
