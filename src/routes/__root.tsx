...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Radhvan Origins provides reliable Cordyceps militaris cultivation training in Jaipur, Rajasthan, research-backed knowledge, lab-grown spawn insights, and practical guidance." },
      { name: "author", content: "Radhvan Origins" },
      { name: "keywords", content: "Radhvan, Radhvan Origins, Cordyceps training in Jaipur, Best Cordyceps training in Jaipur, Cordyceps militaris cultivation Jaipur, Cordyceps farming course Rajasthan, Cordyceps spawn lab Jaipur, lab grown cordyceps, cordycepin research, Cordyceps mushroom farming Jaipur, fungal biotechnology, commercial mushroom cultivation" },
